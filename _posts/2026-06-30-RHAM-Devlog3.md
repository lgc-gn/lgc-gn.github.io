...
![rham model properties](rhamModelStats.png){: width="300" height="300" }
...
![rham model old](rhamOldModel.png){: width="500" height="500" }
...
![rham model old](rhamBeginningArmorConceptArt.png){: width="500" height="500" }
